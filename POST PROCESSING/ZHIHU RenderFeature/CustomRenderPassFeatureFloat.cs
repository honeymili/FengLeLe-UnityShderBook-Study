...
public class CustomRenderPassFeatureFloat : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    {
        //public CustomRenderPassFeatureFloat.Settings settings; 
        public Material material;
        public float a ;
        RenderTexture RT;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.name = "ZHIHU POST";
            material.SetFloat("_A", a);// _A shader里的变量
